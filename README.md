# Simbot springboot starter - Mirai
...
### 阅读
- [listener](src/main/java/simbot/jaiser/listener) 包下为一些监听函数示例。阅读它们的注释，并可以试着修改它们。

### 运行
执行[SimbotExampleApplication](src/main/java/simbot/jaiser/SimbotExampleApplication.java) 中的main方法。
